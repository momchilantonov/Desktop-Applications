...
def users_data():
    ...
    def add():
        ...
        if len(add_user.get()) > 0 and len(add_pass.get()) > 0:
            cur.execute("INSERT INTO users VALUES (:user, :pass)", {"user": add_user.get(),
                                                                    "pass": add_pass.get()})
    ...
    user_canvas.create_text(85, 242, text="User's ID", font=("Courier", 12, "bold", "italic"), fill="#000000")
